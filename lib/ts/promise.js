...
define(["require", "exports"], function (require, exports) {
    ...
    var PromiseA = /** @class */ (function () {
        function PromiseA(executor) {
            ...
            function executeFullfill(status, value) {
     ...
     * @returns {PromiseA}
     */
    function fullfillPromise(status, value, promise) {
        promise.__promise_onFullfilleds = promise.__promise_onRejecteds = undefined;
        //根据状态改变相关成员
        if (status == PromiseStates.fullfilled) {
            promise.then = function (onFullfilled, onRejected) {
                _async(function () { return onFullfilled.call(promise, value); }, 0);
                return promise;
            };
            promise.done = function (onFullfilled, param) {
                _async(function () { return onFullfilled.call(promise, value, param); }, 0);
                return promise;
            };
            ...
            promise.then = function (onFullfilled, onRejected) {
                _async(function () { return onRejected.call(promise, value); }, 0);
                return promise;
            };
            promise.done = function (onFullfilled, param) {
                return promise;
            ...
            promise.fail = function (onRejected, param) {
                _async(function () { return onRejected.call(promise, value, param); }, 0);
                return promise;
            };
        }
        return promise;
